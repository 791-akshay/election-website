...
<html lang="en">
  ...
  <body>
    ...
    <div class="main"><br><br><br>
        <h1 class="dep-name">Electrical Department</h1><br>
        <h3 class="dep-hod-name">Prof. Shaikh Nadeem Bhaimiya</h3>
        <p class="dep-para">Head Of Department Of Electrical Department</p>
