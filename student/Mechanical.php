...
<html lang="en">
  ...
  <nav class="navbar sticky-top navbar-expand-lg ">
    ...
    <div class="main"><br><br><br>
        <h1 class="dep-name">Mechanical Department</h1><br>
        <h3 class="dep-hod-name">Prof. (Dr.) Santosh Shelke</h3>
        <p class="dep-para">Head Of Department Of Mechanical Department</p>
