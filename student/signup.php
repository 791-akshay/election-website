...
<html lang="en">
  ...
  <nav class="navbar sticky-top navbar-expand-lg ">
    ...
    <div class="main"><br>
        <div class="login_container" style="height:640px">
            <div class="d-flex justify-content-center h-100">
                <div class="card" style="height: 640px;width: 500px;">
                    <div class="card-header">
                        <h3 style="text-align: center;margin-top: 15px;">Create Account</h3>
                    </div>
                    <div class="card-body">
                        <form action="" name="Sign Up" method="POST">
                            <div class="input-group form-group">
                                <div class="input-groups">
                                    <span class="input-group-text"><i class="fa fa-users" style="margin-left: 7px;"></i></span>
                                </div>
                            ...
                            <div class="input-group form-group">
                                <div class="input-groups">
                                    <span class="input-group-text"><i class="fa fa-phone" style="margin-left: 7px;"></i></span>
                                </div>
                            ...
                            <div class="input-group form-group">
                                ...
                                <input type="phone" class="form-control" name="prn" placeholder="PRN No." required>
                            </div><br>
                            ...
                            <div class="input-group form-group">
                                <div class="input-groups">
                                    <span class="input-group-text"><i class="fa fa-envelope" style="margin-left: 7px;"></i></span>
                                </div>
...
<?php
  if(isset($_POST['submit']))
  {
    ...
    if($count==0)
    {
      mysqli_query($db,"INSERT INTO `students` VALUES('$_POST[firstname]','$_POST[lastname]','$_POST[uniqueid]','$_POST[prn]','$_POST[phone]','$_POST[email]','$_POST[username]','$_POST[password]');");
      ?>
